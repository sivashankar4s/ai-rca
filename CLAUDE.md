...
specs/019-config-page-enhancements/plan.md
<!-- SPECKIT END -->
...
- **90% test coverage required** — Enforced via `.coverage-thresholds.json` as a blocking gate before PR creation and task completion
